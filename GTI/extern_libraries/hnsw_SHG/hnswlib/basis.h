...
inline float calculateRecall(int &queryID, int &K, std::priority_queue<std::pair<float, hnswlib::labeltype>> &result, int** &groundtruth){
...
inline void load_query_groundtruth(std::string &dataset, int &num_query, float** &queryVectors, int** &groundtruth){
    ...
    std::string query_input = "/home/shiyi/test/SHG-Index/" + dataset + "/" + dataset +"_query.fvecs";
    std::string groundtruth_input = "/home/shiyi/test/SHG-Index/" + dataset + "/" + dataset +"_groundtruth.ivecs";
...
inline void load_query_groundtruth_(std::string &dataset, int &num_query, float** &queryVectors, int** &groundtruth){
...
inline void load_query_groundtruth100m(std::string &dataset, int &num_query, float** &queryVectors, int** &groundtruth){
